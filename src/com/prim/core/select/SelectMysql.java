...
class SelectMysql implements Select {
  ...
  public SelectMysql andOr(List<Condition> cond) throws CloneNotSupportedException {
    ...
    return this;
    */
    return andOr(cond, true);
  }
  
  public SelectMysql onOr(List<Condition> cond) throws CloneNotSupportedException {
    return andOr(cond, false);
  }

  private SelectMysql andOr(List<Condition> cond, boolean checkWhere) throws CloneNotSupportedException {
